# What it does: Detects eyes from a USB camera in real time and prints the frame rate
# Wiring:       Connect a USB camera to the board
# Expected output: Eyes are boxed in red with the FPS value drawn on the live image, press the space bar to exit
