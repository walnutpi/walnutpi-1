# What it does: Detects cat faces from a USB camera in real time and prints the frame rate
# Wiring:       Connect a USB camera to the board
# Expected output: Cat faces are boxed in red with the FPS value drawn on the live image, press the space bar to exit
