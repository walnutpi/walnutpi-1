...
# What it does: Closes the window by connecting the button clicked signal to the window close slot
# Wiring:       No wiring needed (desktop GUI application)
# Expected output: A window with a label and a "close" button is shown, clicking the button closes it
# Tested on:    WalnutPi 1B
# Tutorial:     https://wiki.walnutpi.com/en/docs/walnutpi_1/pyQT5/signal_slot
